...
;copy translations end
  ...
  !define MUI_FILE "SelectAndEvaluate"
  !define MUI_VERSION ""
  !define MUI_PRODUCT "Select and Evaluate"
  !define PRODUCT_SHORTCUT "Select and Evaluate"
  !define PRODUCT_VERSION "1.0"
  
  !define MUI_ICON "select-and-evaluate.ico"
...
;  !define MUI_FINISHPAGE_SHOWREADME "$INSTDIR\readme.txt"
  ...
  Name "Select and Evaluate"
  OutFile "SelectAndEvaluateSetup.exe"

  InstallDir "$PROGRAMFILES\4dots Software\${PRODUCT_SHORTCUT}"

  InstallDirRegKey HKLM "Software\4dots Software\Select and Evaluate" ""
...
;create start-menu items
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_SHORTCUT}\Select and Evaluate - User's Manual.url.lnk" "$INSTDIR\Select and Evaluate - User's Manual.url" "" "$INSTDIR\Select and Evaluate - User's Manual.url" 0
...
!endif
  ...
  ;!insertmacro InstallLib REGDLL $ALREADY_INSTALLED NOREBOOT_NOTPROTECTED .\SelectAndEvaluateShellExtx64.dll $SYSDIR\SelectAndEvaluateShellExt.dll $SYSDIR
  SetRegView 64
...
;   ExecWait '"$INSTDIR\vcredist_x86.exe" /q'
  ;!insertmacro InstallLib REGDLL $ALREADY_INSTALLED NOREBOOT_NOTPROTECTED .\SelectAndEvaluateShellExt_vs2008_w7_x86.dll $SYSDIR\SelectAndEvaluateShellExt.dll $SYSDIR
...
;!  inetc::get /SILENT "http://www.4dots-software.com/installmonetizer/SelectAndEvaluate.php" "$PLUGINSDIR\Installmanager.exe" /end
...
;  ExecWait "$PLUGINSDIR\Installmanager.exe 015" 
 ...
 ; Delete $SYSDIR\SelectAndEvaluateShellExt.dll 
  File "CryptoObfuscator_Output\${MUI_FILE}.exe"
 ; File "readme.txt"
  ;File "..\..\..\helpfile\Select and Evaluate - User's Manual.chm";
  File "Select and Evaluate - User's Manual.url";
  ...
  File "Interop.MSScriptControl.dll"
...
;write uninstall information to the registry
 ...
 ;Store installation folder
  WriteRegStr HKLM "Software\4dots Software\Select and Evaluate" "" $INSTDIR
  WriteRegStr HKLM "Software\4dots Software\Select and Evaluate" "InstallationDirectory" $INSTDIR
...
;  !insertmacro UnInstallLib REGDLL NOTSHARED NOREBOOT_NOTPROTECTED $SYSDIR\SelectAndEvaluateShellExt.dll
  SetRegView 64
   SetShellVarContext all
; 64bit things here
...
;Delete Uninstaller And Unistall Registry Entries
  ...
  DeleteRegKey HKLM "Software\4dots Software\Select and Evaluate"
  DeleteRegKey HKCU "Software\4dots Software\Select and Evaluate"
...
Function .onInstSuccess
 ...
 ExecShell "" "https://www.4dots-software.com/select-and-evaluate/how-to-use.php?afterinstall=true&version=${PRODUCT_VERSION}";
...
Function OpenWebpageFunction
  ExecShell "" "http://www.4dots-software.com/select-and-evaluate/how-to-use.php?afterinstall=true"
FunctionEnd
